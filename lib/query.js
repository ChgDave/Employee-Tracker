    ...
    try {
      ...
      switch (toDo) {
        ...
        case "View All Employees by Department":
          sql =
            "SELECT department_id, name AS department_name, first_name, last_name, title, salary, manager_id From employee LEFT JOIN role ON role.id=employee.role_id LEFT JOIN department ON department.id=role.department_id ORDER BY department_id";
          break;
        ...
        case "View Total Utilized Budget By Department":
          sql =
            "SELECT department_id, name AS department_name, SUM(salary) AS budeget From employee LEFT JOIN role ON role.id=employee.role_id LEFT JOIN department ON department.id=role.department_id GROUP BY department_id";
          break;
      }
